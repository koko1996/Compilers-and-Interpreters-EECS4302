...
public abstract class Composite extends Expression {
	...
	/*
	 * helper function to check if there is any conflict in assignment of values
	 * of left and right expression
	 * 
	 ...
	 * and append it to the given result list
	 * 
	 * @param result list that will have the result of the combination appended
	 * to it
	 * 
	 * @param left assignments of left expression
	 * 
	 * @param right assignments of left expression
	 */
	protected void crossAppend(List<Map<String, Boolean>> result, List<Map<String, Boolean>> left,
